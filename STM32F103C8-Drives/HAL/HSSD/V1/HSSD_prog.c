...
ErrorState_t HSSD_enInit(void)
{
	...
	MGPIO_enSetPinDirection(HSSD_LED_DP_PIN, OUT_2MHZ_PP);
	MGPIO_enSetPinDirection(HSSD_LED_A_PIN, OUT_2MHZ_PP);
	MGPIO_enSetPinDirection(HSSD_LED_B_PIN, OUT_2MHZ_PP);
	MGPIO_enSetPinDirection(HSSD_LED_C_PIN, OUT_2MHZ_PP);
	MGPIO_enSetPinDirection(HSSD_LED_D_PIN, OUT_2MHZ_PP);
	MGPIO_enSetPinDirection(HSSD_LED_E_PIN, OUT_2MHZ_PP);
	MGPIO_enSetPinDirection(HSSD_LED_F_PIN, OUT_2MHZ_PP);
	MGPIO_enSetPinDirection(HSSD_LED_G_PIN, OUT_2MHZ_PP);
